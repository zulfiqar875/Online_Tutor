                ...
                <i class="fa fa-user-circle-o fa-3x text-white" aria-hidden="true"></i>
                    ...
                    <div class="row">
                        ...
                        <label class="text-light" for="">Subject Name</label> <br>
                            <input type="text" disabled value="{{$group->Subject}}" id="" class="form-control">
                        </div>
                        <div class="col-sm-3 col-lg-3 col-xl-3">
                            <label class="text-light" for="">Class</label> <br>
                            <input type="text" disabled value="{{$group->Class}}" id="" class="form-control">
                        </div>
                        <div class="col-sm-3 col-lg-3 col-xl-3">
                            <label class="text-light" for="">Area</label> <br>
                            <input type="text" disabled value="{{$group->Location}}" id="" class="form-control">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <label class="text-light" for="">Availabily Area</label> <br>
                            <input type="text" disabled value="{{$group->Date}}" id="" class="form-control">
                        </div>
                        <div class="col-sm-3 col-lg-3 col-xl-3">
                            <label class="text-light" for="">Start Time</label> <br>
                            <input type="text" disabled value="{{$group->Time}}" id="" class="form-control">
                        </div>
