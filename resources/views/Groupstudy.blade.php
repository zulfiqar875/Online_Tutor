...
<body>
        ...
        <h3 class="text-light text-center mt-5 mb-5">Available Groups Now - {{$data->count()}} </h3>
        {{-- ......................................................................................................... --}}
                                            {{-- REGISTRATION FORM --}}
        {{-- ......................................................................................................... --}}
                ...
                <table class="table table-striped text-light disabled">
                    ...
                    <tbody>
                        @foreach ($data as $group)
                            <tr>
                                <td class=""><i class="fa fa-user-circle-o fa-1x" aria-hidden="true"> {{$group->Tname}}</i> </td>
                                <td>{{ $group->Subject }}</td>
                                <td>{{ $group->Class }}</td>
                                <td>{{ $group->Location }}</td>
                                <td>{{ $group->Date}} to {{$group->Time}} </td>
                                <td>
                                    <form action="{{url('/groupstudydetail',[$group->Tid, $group->Gid])}}" method="post">
                                        @csrf
